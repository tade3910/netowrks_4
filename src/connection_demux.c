                                ...
                                mysock_context_t **new_ctx)
{
    ...
    *new_ctx = _mysock_get_context(r->request->sd);
    assert(*new_ctx);
    fprintf(stderr, "Gotten sock context\n");
    fflush(stderr);
